...
json_file = open('Saved-Models/model7723.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
# model = model_from_json(loaded_model_json)

# Load weights and them to model
# model.load_weights('Saved-Models/model7635.h5')

model = load_model("MobileNetV2_face_emotion.model")
